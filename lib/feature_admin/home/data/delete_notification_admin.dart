...
class DeleteNotificationAdmin {
  final NetworkHandler networkHandler = NetworkHandler();

  Future<NotificationUserDelete> deleteNotificationAdmin(int id) async {
    try {
      final response = await networkHandler.delete('http://194.164.77.238/notfications_provider/delete/$id/');
